"""
Django settings for skillcrafts_test_framework project.
...
ROOT_URLCONF = 'skillcrafts_test_framework.urls'
...
WSGI_APPLICATION = 'skillcrafts_test_framework.wsgi.application'
...
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'test_platform/static')]  # если статика лежит в приложении
