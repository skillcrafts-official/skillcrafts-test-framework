...
В итоге процесс создания тестов ничем не отличается от процесса написания ручных тест-кейсов. А результат тестирования можно использовать для "восстановления" человеко-читаемых ручных тест-кейсов с привычными атрибута.